...
|memscope_dump_{_timestamp_}.db|Memory information file in .db format. It is saved in the **msmemscope_{*PID*}_{_timestamp_}_ascend/device_{*device_id*}/dump** directory by default. You can use MindStudio Insight to display this file. For details, see [MindStudio Insight Memory Tuning](https://gitcode.com/Ascend/msinsight/blob/26.1.0/docs/en/user_guide/memory_tuning.md).|
