...
此外在运行本样例中的python场景时，需要配置torch以及TorchNPU，具体请参见[Pytorch框架训练环境准备](https://www.hiascend.com/document/detail/zh/Pytorch/latest/installguide/swinstall/docs/zh/installation_guide/installation_via_binary_package.md)文档。
...
| 参数 | 可选/必选 | 说明 |
|------|-----------|------|
| format | 可选 | 指定落盘文件的格式，默认为csv格式，可更改为db格式。 |
| output_path | 可选 | 指定落盘文件的位置，默认为当前目录下。 |
